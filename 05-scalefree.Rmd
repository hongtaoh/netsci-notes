...
The data I used is called ["Internet"](http://www-personal.umich.edu/~mejn/netdata/as-22july06.zip) from [http://www-personal.umich.edu/~mejn/netdata/](http://www-personal.umich.edu/~mejn/netdata/). I'll use R to plot it. See the result in \@ref(fig:powerLaw-poisson)
