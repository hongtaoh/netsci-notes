...
- 2-2-3. Do the same thing using [numpy's mean function](https://numpy.org/doc/stable/reference/generated/numpy.mean.html) which takes in a list and returns the mean of this list. 
  ...
  - **Note**: I didn't understand Professor YY's note here: "so if you print a numpy float it will display differently than if you printed a python float, which is why we get the intentional truncation of the value when displayed".
